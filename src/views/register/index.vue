    ...
    <div style="margin-top: 10px">
      <div class="box">
        ...
        >
          ...
          <div class="user-info">
            <span>状态：<van-tag :type="item.status|filterResTag">{{item.status|filterResStatus}}</van-tag></span>
...
<script>
import { getRegisterList,patList } from "../../api/api";
...
export default {
  ...
  methods: {
    queryRegisterList() {
      ...
      getRegisterList(this.params).then((res) => {
    ...
    go_detail(item) {
      ...
      this.$router.push({ path: `register-detail` });
    },
  },
  mounted() {
